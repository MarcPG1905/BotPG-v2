...
public class BotPGv2 extends ListenerAdapter {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JDA = JDABuilder.createDefault(Config.TOKEN, GatewayIntent.GUILD_MESSAGES, GatewayIntent.MESSAGE_CONTENT, GatewayIntent.GUILD_MEMBERS)
                .addEventListeners(new Tickets(), new SlashTicketMsg(), new SlashModUtil(), new SlashStats(), new PrivateCommands(), new SlashSource(), new SlashSocials(), new SlashClear(), new SlashAvatar(), new MessageEvent(), new BotPGv2())
